...
@pytest.mark.parametrize('departments, expected', EMPTY_DEPARTMENTS)
def test_empty_departments(departments: dict, expected: tuple[int, int]):
    """Test case for the function with empty departments.

    Args:
        departments: containing names of departments and their respective employees' salaries.
        expected: expected result of function.
    """
    assert calculate_salary_stats(**departments) == expected
